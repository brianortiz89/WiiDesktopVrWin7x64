...
namespace WiiDesktopVR
{
	...
	public class WiiDesktopVR : Form
	{
        ...
        String textureFilename = "target1.png";
            ...
            if (doWiimote)
            {
                try
                {
                    if (doWiimote2)
                    {
                        ...
                        remote2.WiimoteChanged += new WiimoteChangedEventHandler(wm_OnWiimoteChanged2);
                    }
                    remote = new Wiimote();
                    remote.Connect();
                    ...
                    remote.WiimoteChanged += new WiimoteChangedEventHandler(wm_OnWiimoteChanged);
